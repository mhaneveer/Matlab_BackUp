function sgpTLE(NORAD_ID)

verificationPath = 'D:\Documents\TU_Delft\MSc\Thesis\02_Program\Data\CubeSat_Verification\';

TLE_path = [verificationPath num2str(NORAD_ID) '_ver.txt'];


verificationPath = 'D:\Documents\TU_Delft\MSc\Thesis\02_Program\Data\Verify\Data\';
TLE_path = [verificationPath 'TLE_60_asc_yr_2000.txt'];
...
dlmwrite([verificationPath num2str(NORAD_ID) '_CART.txt'],...
